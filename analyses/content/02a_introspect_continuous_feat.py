...
# Testing performance on addition test set only using a normally distributed features.
# This shows whether increase in performance is due to leakage or only better
...
# Therefore, we will look at the real_estate dataset.
# %% tags=["hide-input", "hide-output"]
...
# %% [markdown]
# Now, we retrain and score a decision tree using only these features
